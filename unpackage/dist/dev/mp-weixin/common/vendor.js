...
const pages = [
  {
    path: "pages/opendb-search-log/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/opendb-search-log/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/opendb-search-log/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/opendb-search-log/detail",
    style: {
...
const tabBar = {
  ...
  list: [
    {
      pagePath: "pages/opendb-search-log/list",
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.100.19",\n        "192.168.244.14",\n        "172.24.224.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"laowang","spaceId":"mp-8ad6a9d3-b3f6-4605-a575-311f199c8407","clientSecret":"0dfSuZCJSnq12AX2MntKbQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__9774101";
} catch (e2) {
